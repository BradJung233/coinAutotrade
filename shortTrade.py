        ...
        if start_time + datetime.timedelta(seconds=60) < now < end_time:
            for coin in coins:
                ...
                if (coinjan * globals()['current_price_{}'.format(coin)]  > 5000 and globals()['buy_price_{}'.format(coin)]*1.05 < globals()['current_price_{}'.format(coin)] and 
                    globals()['rsi_{}'.format(coin)] <60 and globals()['rsi_b1_{}'.format(coin)] < 60 and globals()['rsi_b2_{}'.format(coin)] < 60 and globals()['rsi_b3_{}'.format(coin)] < 60):  
                    sell_continue_chk = True
                    if globals()['rsi_b3_{}'.format(coin)] == 0:
                        sell_continue_chk = False
                ...
                if (coinjan * globals()['current_price_{}'.format(coin)]  > 5000 and 1.01 < (globals()['buy_price_{}'.format(coin)]/ globals()['current_price_{}'.format(coin)]) <1.03
                    and globals()['current_price_{}'.format(coin)] < globals()['past_b20_price_{}'.format(coin)] and globals()['current_price_{}'.format(coin)] < globals()['past_b10_price_{}'.format(coin)] 
                    and globals()['current_price_{}'.format(coin)] < globals()['past_price_{}'.format(coin)] ):
                    sell_continue_chk = True
