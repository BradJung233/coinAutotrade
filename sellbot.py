...
# -----------------------------------------------------------------------------
except_item = 'BTC,XLM,XRP' # ex 'ETH,BTC'
# 제외 데이터
            ...
            for target_item in target_items:
                for ticker in tickers:
                    ...
                    for exceptItemFor in except_items:
                        item = str(target_item['market'])
                        item = item.replace("KRW-","")
                        # print('exceptItemFor',exceptItemFor,'item',item)
                        if exceptItemFor == item:
                            exceptTrue = True
                    if exceptTrue:
                        continue        
...
# 백그라운드 실행: nohup python3 -u sellbot.py > nohup2.out &
